        ...
        <Link href={`produto/${item.slug}`}>
            ...
            >
                ...
                <div className="flex flex-col justify-between">
                    <p className="max-w-[115px] text-base leading-[1] font-bold group-hover:text-white">
                        {item.name}
                    </p>
                    <p className="w-max rounded-full text-xs font-semibold bg-red-castle px-2 text-white group-hover:bg-white group-hover:text-red-castle">
                        {item.category}
                    </p>
                </div>
